...
export async function generateMetadata({ params }: PageProps) {
	...
	return {
		title: `${study.frontmatter.title} | Case Studies - ${seo.location.city}`,
...
export default async function CaseStudyPage({ params }: PageProps) {
	...
	const jsonLd = {
		...
		"@graph": [
			// Breadcrumb schema
			generateCaseStudyBreadcrumbs(study.frontmatter.title),
			...
			generateArticleSchema({
				...
				slug: study.slug,
				datePublished:
					study.frontmatter.completedDate ||
					new Date().toISOString().split("T")[0],
				image: study.frontmatter.heroImage,
